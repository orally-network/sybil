...
dfx canister call sybil create_custom_feed "(record {feed_id=\"BTC/USDT\"; feed_type=variant {Custom}; update_freq=3600:nat; decimals=6:nat; sources=vec {record {uri=\"https://api.pro.coinbase.com/products/BTC-USDT/candles?granularity=60&start=1661523960&end=1661523960\"; resolver=\"/0/0\"}};msg=\"${SIWE_MSG}\"; sig=\"${SIWE_SIG}\"})"
